...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midbottom = (350, random_pipe_pos - 300))
...
pygame.mixer.pre_init(44100, size = 16, channels = 1, buffer = 256)
pygame.init()
...
while True:
    for event in pygame.event.get():
        #Drawing the basic black screen
